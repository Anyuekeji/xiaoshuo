...
@interface AYCartoonDetailViewModel ()
@property(nonatomic,strong) NSArray *recommentArray; //推荐数据

@property(nonatomic,strong) NSArray *itemArray; //小说总章节数
@end
@implementation AYCartoonDetailViewModel
- (void) setUp
{
    [super setUp];
    _cartoonDetailModel = [AYCartoonDetailModel new];
    _itemArray = [NSArray arrayWithObjects:@"head",@"reward",@"empty",@"invate",@"charge",@"empty",nil];
